...
public class HomeController {
	...
	//Called automatically whenever Controller called: responsible to showing user name logged-in info in navbar dynamically
	@ModelAttribute
	...
	//Handle code of product & category on homepage
	@GetMapping("/products")
